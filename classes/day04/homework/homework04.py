...
def regist():
    ...
    with open(r'usr_info.txt',mode='r',encoding='utf-8') as f:
        while True:
            lst_user = []
            for line in f:
                line = line.strip()
...
while flag:
    ...
    while flag:
        if iput == '2':
            ...
            collect()
            flag = False    #此处的flag = False 可以单独写一个装饰器，或者直接写在主函数里，将来可替换成跳转url的方法
        else:
            print('无此选项，重新选择')
            break