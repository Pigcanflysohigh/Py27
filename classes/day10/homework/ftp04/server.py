	...
	def handle(self):
		...
		if dic['flag']:
			while True:
				...
				remote_path = '/Users/malingang/Knowledge/Python/Pycharm_Project/Py27/classes/day10/homework/ftp04/remote'
...
sk = socketserver.ThreadingTCPServer(('127.0.0.1',9002),Myserver)
