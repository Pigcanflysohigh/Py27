...
class Myserver(socketserver.BaseRequestHandler):
	...
	def upload(self,opt_dic,base_name,remote_path):
	...
	def download(self,opt_dic,base_name,remote_path):
				...
				if dic['flag']:
					while True:
						...
						if opt_dic['operate'] == 'upload':
							self.upload(opt_dic,base_name,remote_path)
						elif opt_dic['operate'] == 'download':
							self.download(opt_dic,base_name,remote_path)
						elif opt_dic['operate'] == 'quit':
							self.quit(base_name)
		except Exception:
